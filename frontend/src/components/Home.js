    ...
    return (
        <div>
            ...
            <div className="flex py-20 h-screen bg-gradient-to-b from-[#667eea] to-[#764ba2] justify-center text-center items-center">
                ...
                <button className=" bg-white text-background-dark-color font-bold rounded-full py-4 px-10 shadow-lg uppercase tracking-wider hover:bg-background-dark-color hover:text-light-purple hover:shadow-lg border-bright-purple border-2 border-solid">
