        ...
        <div>
            ...
            {/* <div style={{background: "linear-gradient(#e66465, #9198e5)"}} style={{background: "linear-gradient(#667eea, #764ba2)"}}></div> */}
                <div className="container mx-auto px-6">
                    <h2 className="text-4xl font-bold mb-2 text-white">Shop With Your Friends!</h2>
                    <h3 className="text-2xl mb-8 text-gray-200">Share your shopping list with anyone you want on your next trip.</h3>
